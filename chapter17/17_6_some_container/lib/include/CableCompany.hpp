...
{
    public:
        // 지정한 채널에 대한 패키지 상품을 데이터베이스에 저장한다.
        ...
        // 가입자 정보를 패키지에 담긴 채널로 초기화해서 데이터베이스에 추가한다.
        // 패키지 이름이 잘못되면 out_of_range 익셉션을 던진다.
        // 이미 저장된 가입자를 지정하면 invalid_argument익셉션을 던진다.
        ...
        // 모르는 가입자를 지정하면 invalid_argument익셉션을 던진다.
